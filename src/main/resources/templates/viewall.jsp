...
<body>
    ...
    <div class="container">
        <div class="card">
            <img src="shirts.jpg" alt="Card 1">
            <h2>Men</h2>
            <div class="text-center">
			    <button type="submit" class="orange-button" onclick="redirectToPage('men')" >View All Men's Fashion</button>
			</div>
        </div>

        <div class="card">
            <img src="dresses.jpg" alt="Card 2">
            <h2>Women</h2>
            <div class="text-center">
			    <button type="submit" class="orange-button" onclick="redirectToPage('women')">View All Women's Fashion</button>
			</div>
        </div>

        <div class="card">
            <img src="kids.jpeg" alt="Card 3">
            <h2>Kids</h2>
          <div class="text-center">
			    <button type="submit" class="orange-button" onclick="redirectToPage('kids')" >View All Kid's Fashion</button>
			</div>
        </div>
        <script>
